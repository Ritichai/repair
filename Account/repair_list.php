...
<html lang="en">
    ...
    <body style="background-color: #eff2f4">
        ...
        <div  class="container">
            ...
            $sql = "select oe.oe_id,oe.oe_code,oe.oe_name, position.position_name from position "
                    . "inner join oe ON oe.oe_position=position.position_id "
                    . "WHERE oe.oe_code like '%$text_serch%' and oe_position =1 "
                    . "order by oe_id limit {$start} , {$perpage} ";
            ...
            <div class="container" style="padding-top: 20px;">
                <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="หมายเลข SN" id="text_serch" name="text_serch">
                        ...
                        <tbody>
                            <?php while ($result = mysqli_fetch_assoc($query)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $result['oe_code']; ?></td>
                                    <td><?php echo $result['position_name']; ?></td>
                                    <td>
                                        <a href="repair_view.php?oe_id=<?php echo $result['oe_id'];?>"class="btn btn-warning col-12"><i class="fas fa-wrench"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    ...
                    $sql2 = "select * from oe  where oe_position =1 order by oe_id ";
