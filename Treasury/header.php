...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            ?>"><a class="nav-link"  href="add_oe.php"><b>เพิ่มอุปกรณ์สำนักงาน</b></a></li>
        </ul>
        <ul class="navbar-nav">
        ...
        <ul class="navbar-nav">
             <?php {
                            ...
                            ?>
            <li><a class="nav-link" href="Waiting.php"><b>อุปกรณ์ซ่อมเสร็จรอรับ</b><span class="badge badge-danger"><?php echo $count;?></span></a>
            </li>
                            <?php } ?>
        </ul>
    </div>
